...
{
    /// <summary>
    /// Класс, создающий деталь Вкладыш Е38.
    /// </summary>
    public class LinerPartE38 : ProfileE38
    {
        ...
        public LinerPartE38(Inventor.Application invApp, double lengthLiner, string materialProfile = "", string colorProfile = "") :
