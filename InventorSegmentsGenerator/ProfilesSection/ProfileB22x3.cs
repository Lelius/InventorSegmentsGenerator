...
{
    public class ProfileB22x3 : ProfileFrameSection
    {
        ...
        public ProfileB22x3(Inventor.Application m_inventorApplication, double lengthProfile, string materialProfile = "", string colorProfile = "")
        ...
        public void createProfile()
        {
            ...
            oCircleOutside = oSketch.SketchCircles.AddByCenterRadius(pointCenter, 1.1);
            oCircleInside = oSketch.SketchCircles.AddByCenterRadius(pointCenter, 0.8);
